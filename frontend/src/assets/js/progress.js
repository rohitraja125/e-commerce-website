  ...
  (s.prototype = {
    ...
    initFill: function () {
      function i() {
        ...
        (i.width = e.size),
          (i.height = e.size),
          i.getContext("2d").drawImage(t, 0, 0, r, r),
          (e.arcFill = e.ctx.createPattern(i, "no-repeat")),
    ...
    (g.circleProgress = { defaults: s.prototype }),
